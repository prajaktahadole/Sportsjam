...
import './checkout.css'
  const CheckoutHandler = ()=>{
    return(
        ...
        <div>
          <div>
            <img src='https://storage.sg.content-cdn.io/in-resources/b368029c-a4dd-448a-a888-58348cb1b144/Images/userimages/logo.jpg'></img>
          </div>
        ...
        <div className="row">
          <div className="col-50">
            ...
            <input type="text" id="email" name="email" placeholder="user@gmail"/>
            <label htmlFor="adr"><i className="fa fa-address-card-o"></i> Address</label>
            <input type="text" id="adr" name="address" placeholder="Aurangabd"/>
            <label htmlFor="city"><i className="fa fa-institution"></i> City</label>
            <input type="text" id="city" name="city" placeholder="Aurangabad"/>
            ...
            <div className="row">
              ...
              <div className="col-50">
                ...
                <input type="text" id="zip" name="zip" placeholder="431001"/>
              </div>
            </div>
          </div>
          ...
          <div className="col-50">
            ...
            <input type="text" id="cname" name="cardname" placeholder="SBI"/>
